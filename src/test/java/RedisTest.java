import com.lyz.user.service.RedisService;
...
public class RedisTest {
    public static void main(String[] args) throws InterruptedException {
        ApplicationContext app = new ClassPathXmlApplicationContext("classpath:lyz-applicationContext.xml");
      ...
      /*  redisService.set("username", "oyhkU");//设值(查看了源代码,默认存活时间30分钟)
